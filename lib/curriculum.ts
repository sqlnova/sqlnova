...
export const INTRO_SLIDES = [
  {
    ...
    subtitulo: 'Una base de datos es como una libreta organizada donde guardás información. En vez de papel, todo queda en la computadora y podés encontrarlo al instante — aunque sean millones de registros.',
    tipo: 'svg' as const,
  },
  {
    id: '00-02',
  ...
  },
  {
    ...
    subtitulo: 'Una base de datos se divide en tablas. Cada tabla guarda un tipo de información y se relaciona con las demás. Por ejemplo, una tienda tiene una tabla de clientes, otra de productos y otra de pedidos — todas conectadas.',
    tipo: 'der' as const,
  },
  {
    id: '00-04',
    titulo: 'Las columnas definen qué guardás',
    subtitulo: 'Las columnas definen qué tipo de información se guarda en cada tabla. Son como las preguntas de un formulario: nombre, edad, ciudad. Cada columna tiene un tipo de dato específico.',
    tipo: 'tabla' as const,
    hlCols: true, hlRow: -1,
  },
  {
    ...
    subtitulo: 'Cada fila es un registro completo: una persona, un producto, un pedido. La primera fila nos dice todo sobre Ana García: su id, nombre, edad y ciudad.',
    tipo: 'tabla' as const,
  ...
  },
  {
    ...
    subtitulo: 'Una tabla combina columnas (qué tipo de dato) y filas (cada registro). Es como una planilla de Excel, pero diseñada para manejar millones de registros de forma eficiente.',
    tipo: 'tabla' as const,
    hlCols: true, hlRow: 0,
  },
  {
    ...
    subtitulo: 'SQL (Structured Query Language) es el lenguaje que usás para hablarle a una base de datos. Con SQL podés consultar datos, filtrarlos, combinar tablas y generar reportes. Lo usan analistas, developers, científicos de datos y cualquier persona que trabaje con información.',
    tipo: 'sql' as const,
  },
  {
    id: '00-08',
    titulo: '¡Listo para empezar!',
    subtitulo: 'Ya sabés los conceptos base: base de datos, tablas, columnas, filas y SQL. En el Módulo 1 vas a escribir tu primera consulta real.',
