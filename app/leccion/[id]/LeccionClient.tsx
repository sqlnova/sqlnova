...
if (ultimaActividad === hoy) {
  // Ya completó algo hoy — racha no cambia
} else if (ultimaActividad === ayer) {
  // Completó algo ayer — racha sube 🔥
  nuevaRacha = nuevaRacha + 1
  rachaSubio = true
} else {
  // Sin actividad reciente — racha empieza en 1
  nuevaRacha = 1
  rachaSubio = true
}

const nuevaRachaMaxima = Math.max(nuevaRacha, perfil?.racha_maxima || 0)
